 ...
 */
(function(c, l) { "function" === typeof define && define.amd ? define(["jquery"], function(k) {
        return l(k, c, c.document, c.Math) }) : "undefined" !== typeof exports ? module.exports = l(require("jquery"), c, c.document, c.Math) : l(jQuery, c, c.document, c.Math) })("undefined" !== typeof window ? window : this, function(c, l, k, n, H) {
    var m = c(l),
        r = c(k);
    c.fn.fullpage = function(d) {
        ...
        function ha() { c(".fp-section").each(function() {
        ...
        function M(a, b) {
            if (h.m[a]) {
                var d, c; "down" == a ? (d = "bottom", c = e.moveSectionDown) : (d = "top", c = e.moveSectionUp);
                if (0 < b.length)
        ...
        function Oa(a) { a = a.originalEvent;
        ...
        function J(a) {
            ...
            b.length && (a = c(b));
            a.find("img[data-src], video[data-src], audio[data-src]").each(function() { c(this).attr("src", c(this).data("src"));
        ...
        function Pa(a) { a.find("video, audio").each(function() {
                var a = c(this).get(0);
        ...
        function F(a, b) {
            ...
            if (d.onSlideLeave) {
                ...
                if (!p && "none" !== r && c.isFunction(d.onSlideLeave) && !1 === d.onSlideLeave.call(t, k, h + 1, q, r, e)) { w = !1;
                    return } }
            ...
            var u = function() { p || c.isFunction(d.afterSlideLoad) && d.afterSlideLoad.call(b, k, h + 1, m, e);
                w = !1 };
        ...
        function za() { Aa();
            if (R) {
                ...
                a.is("textarea") || a.is("input") || a.is("select") || (a = m.height(), n.abs(a - fa) > 20 * n.max(fa, a) / 100 && (e.reBuild(!0), fa = a)) } else clearTimeout(ga), ga = setTimeout(function() { e.reBuild(!0) }, 350) }
        ...
        function Ta(a, b) {
            if (825 > a || 900 > b) {
                ...
                p.css("font-size", d + "%") } else p.css("font-size", "100%") }

        function L(a, b) { d.menu && (c(d.menu).find(".active").removeClass("active"), c(d.menu).find('[data-menuanchor="' + a + '"]').addClass("active"));
        ...
        function Ba(a) { a.find(".fp-scrollable").children().first().unwrap().unwrap();
        ...
        function sa(a, b) { b ? wa(f) : f.addClass("fp-notransition");
            f.css(xa(a));
        ...
        function ea(a, b) {
            var d = Ea(a); "undefined" === typeof b && (b = 0);
        ...
        function Ua(a, b) { a.append('<div class="fp-slidesNav"><ul></ul></div>');
        ...
        function va(a) {
            var b = a.data("anchor");
            a = a.index(); "undefined" === typeof b && (b = a);
            return b }
        ...
        function Ia() {
            return l.PointerEvent ? { down: "pointerdown", move: "pointermove" } : { down: "MSPointerDown", move: "MSPointerMove" } }
        ...
        function ba(a, b) { e.setScrollingSpeed(0, "internal"); "undefined" !== typeof b && (v = !0);
        ...
        function Ya() {
            ...
            c(".fp-section, .fp-slide").each(function() { Ba(c(this));
        ...
        c.extend(c.easing, { easeInOutCubic: function(a, b, c, d, e) {
                return 1 > (b /= e / 2) ? d / 2 * b * b * b + c : d / 2 * ((b -= 2) * b * b + 2) + c } });
        c.extend(c.easing, { easeInQuart: function(a, b, c, d, e) {
        ...
        e.silentMoveTo = function(a, b) { e.setScrollingSpeed(0, "internal");
            e.moveTo(a, b);
            e.setScrollingSpeed(G.scrollingSpeed, "internal") };
        e.moveTo = function(a, b) {
            var c = Ea(a); "undefined" !== typeof b ? ea(a, b) : 0 < c.length && B(c) };
        ...
        c(".fp-section").each(function(a) {
            ...
            if (0 < f) {
                ...
                e.each(function(a) { c(this).css("width", h + "%");
        ...
        var Q = 0;
        r.on("click touchstart", "#fp-nav a", function(a) { a.preventDefault();
